...
import { Heart, ShoppingCart, Trash2, Sparkles, Package, ArrowRight } from 'lucide-react';
...
const Wishlist = () => {
  ...
  const handleAddToCart = (product) => {
    addToCart(product);
    showToast(`${product.name} ${t('messages.added_to_cart')}`);
  };
        ...
        <AnimatedSection animation="fade-up">
          <div className="wishlist-hero">
            ...
            <p className="hero-description">
              {wishlist.length > 0 
                ? t('wishlist.count_text', { count: wishlist.length }).replace('{{count}}', wishlist.length)
              ...
              <div className="wishlist-toolbar">
                <div className="toolbar-info">
                  ...
                  <div className="info-item">
                    ...
                    <span className="info-value">{totalPrice.toLocaleString()} so'm</span>
                  </div>
                </div>
                <button onClick={handleAddAllToCart} className="btn-ultra btn-ultra-primary">
                    ...
                    <div className="card-image-section">
                      ...
                      <div className="product-icon-display">
                        <svg width="64" height="64" viewBox="0 0 40 40" fill="none">
                          <path d="M20 5C20 5 12 12 12 20C12 24.4183 15.5817 28 20 28C24.4183 28 28 24.4183 28 20C28 12 20 5 20 5Z" fill="url(#gradient-card)" />
                          <defs>
                            <linearGradient id="gradient-card" x1="12" y1="5" x2="28" y2="28">
                    ...
                    <div className="card-content-section">
                      <div className="product-meta">
                        <span className="product-category">
                          {product.category === 'water' ? `💧 ${t('wishlist.water')}` : `🔧 ${t('wishlist.filter')}`}
                        </span>
                      </div>
                      
                      <h3 className="product-title">{t(`data.products.${product.id}.name`) || product.name}</h3>
                      <p className="product-desc">{t(`data.products.${product.id}.description`) || product.description}</p>
